    ...
    <div class="page-content">
		...
		<div class="panel panel-default">
			<div class="panel-heading">Editar categoria</div>
				<form id="custom" method="post" action="include/categoriasUpdate.php">
					<div class="form-group" >
						<label for="id">ID</label>
						<input type="text" class="form-control" name="id" id="id" value="<?php echo $_GET['id']?>" readonly>
						<label for="nome">Nome da categoria</label>
						<input type="text" class="form-control" id="nome" name="nome" placeholder="Nome da categoria" value="<?php echo $_GET['nome']?>">
					</div>
