...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer
  ...
  <!-- Your content goes here -->
    <div class="page-content">
				...
				include 'include/categoriasRead.php';
						...
						<div class="table-responsive">
							<table class="table table-hover">
								...
								echo '<tr>
									...
									<td>
										<a class="mdl-navigation__link" id="#tt1" href="editar_categoria.php?id='.$row->id.'&nome='.$row->nome.'">
										<i class="material-icons">edit</i></a>
									</td>
									<td>
										<a class="mdl-navigation__link" id="#tt2" href="include/categoriasDelete.php?id='.$row->id.'">
	...
	<div class="modal fade bs-example-modal-lg" id="add" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<form method="post" action="include/categoriasCreate.php">
					<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							<h4 class="modal-title" id="myModalLabel">Adicionar categoria</h4>
						</div>
						<div class="modal-body">
							<input type="text" class="form-control mod-pad" name="nome" placeholder="Nome da categoria" value="" required>
						</div>
